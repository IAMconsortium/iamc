...
The package comes with small example data set `example_REMIND` supposed to be validated against the configuration 'CDLINKS'. To show the functionality of the package some mistakes have been introduced into the data set. To find these mistakes you can feed the object to the check function `iamCheck`:
